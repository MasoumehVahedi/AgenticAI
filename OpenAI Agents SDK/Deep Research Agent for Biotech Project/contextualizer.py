...
INSTRUCTIONS = (
    ...
    "You will be provided with the original query, the user's answer to that query, the clarifying questions, "
    "the purpose of each clarifying question and the user's answer to each clarifying question.\n"
